...
docker build -t docker.pkg.github.com/mzakyfrz17/a433-microservices/karsajobs:latest .
...
docker push docker.pkg.github.com/mzakyfrz17/a433-microservices/karsajobs:latest
